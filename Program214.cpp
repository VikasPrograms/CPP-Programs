...
// Insert First & Last.  (SinglyLL obj1 and obj2)
// Delete First & Last.  (SinglyLL obj1 and obj2)
...
//----------------------------------------------------------------------------------
    ...
    cout<<"Number of InsertFirst nodes are : "<<obj2.iCount<<"\n";
...
//----------------------------------------------------------------------------------
    ...
    obj2.InsertLast(1111);
    obj2.Display();

    obj2.InsertLast(1222);
    obj2.Display();

    obj2.InsertLast(1333);
    obj2.Display();
    
    cout<<"Number of InsertLast nodes are : "<<obj2.iCount<<"\n";
...
//----------------------------------------------------------------------------------
    ...
    cout<<"Number of DeleteFirst nodes are : "<<obj2.iCount<<"\n";
...
//----------------------------------------------------------------------------------
    ...
    cout<<"Number of DeleteLast nodes are : "<<obj2.iCount<<"\n";
